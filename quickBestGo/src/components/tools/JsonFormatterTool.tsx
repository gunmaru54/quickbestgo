...
export default function JsonFormatterTool({ dict }: JsonFormatterToolProps) {
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
            >
