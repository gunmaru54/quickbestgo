...
export default function RootPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && typeof navigator !== 'undefined') {
      ...
      // Validate against approved list before URL construction (Open Redirect prevention)
      const finalLocale = locales.includes(browserLang) ? browserLang : defaultLocale;
