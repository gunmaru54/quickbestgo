...
export async function generateMetadata({ params: { lang } }: { params: { lang: Locale } }): Promise<Metadata> {
  ...
  return constructMetadata({ title: dict.percentage_calculator.meta_title, description: dict.percentage_calculator.meta_description, lang, slug: 'percentage-calculator' });
}
